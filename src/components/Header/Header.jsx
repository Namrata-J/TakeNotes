        ...
        <div className="tn_header-component">
            <div className="tn_header-content">
                ...
                <div className="tn_icons-section">
                    <GiToggles className="tn_header-settings-icon header-icon" onClick={() => getThePopUpFilterAndSortDisplay()} />
            ...
            <div className="tn_filter-popUp-outerContainer" style={{ display: popUpFilterAndSortDisplay }}>
                <div className="tn_filter-popUp b-rad1">
                    <div className="tn_filter-container1">
                        <h4>Sort & Filter Notes</h4>
                        <GrFormClose className="tn_filter-popUp-closeBtn" onClick={() => closeThePopUpFilterAndSort()} />
                    </div>
                    <div className="tn_filter-container2">
